...
- **Subscriber**: Сервис для управления списком пользовательских подписок.
...
| :--- | :--- | :--- | :--- |
| **GET** | `/api/ping`| проверить состояние системы. | `200`, `503`, `429`|
| **GET** | `/api/repositories/info?url=...` | Инфо о репозитории. Если нет в кэше — инициирует сбор. | `200`, `404`,`400`,`500`, `429` |
| **GET** | `/subscriptions` | Список всех активных подписок. | `200`, `500`, `429` |
| **POST** | `/subscriptions` | Подписка на репозиторий. Проверяет наличие на GitHub. | `200`, `400`, `404`,`500`,`409`, `429` |
| **DELETE** | `/subscriptions/{owner}/{repo}` | Отписка и очистка кэша в Processor. | `200`, `400`,`500`, `429` |
| **GET** | `/subscriptions/info` | Статистика по всем подпискам сразу (из кэша). | `200`,`500`, `429` |
